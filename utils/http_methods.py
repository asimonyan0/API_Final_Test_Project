# """ \API_Final_Test_Project> python -m pytest --alluredir=allure_results/ tests/test_star_wars_api.py  создаем директорию для allure
...
# """ API_Final_Test_Project> allure serve allure_results  В Командной Строке  WINDOWS!! можно генерить отчет в браузере
# или allure serve C:\Users\Armen\PycharmProjects\API_Final_Test_Project\allure_results  в консоли IDE"""
